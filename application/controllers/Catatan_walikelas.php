...
public function index()
	{
        ...
        $semester=$this->db->query('select semester from catatan_walikelas group by semester')->result();
    ...
    $kelas=$this->db->query("select * from catatan_walikelas a join kelas b on(a.id_kelas=b.id_kelas)")->result();
