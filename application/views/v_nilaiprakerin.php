...
<div class="container">
 ...
 <h4>Tambah Data Nilai Prakerin</h4>
 </div>
 <div class="card-body">
...
<div class="form-group">
 ...
 <!-- <div class="form-group">
 <label class="font-weight-bold" for="nama">Jurusan</label>
...
$(document).ready(function(){
	...
	// 	$.ajax({
	// 		url:"<?php echo base_url('index.php/prakerin/get_jurusan');?>",
	// 		method : "POST",
	// 		data : {kelas: kelas},
	// 		async : true,
	// 		dataType : 'json',
	...
	// 			for(i=0; i<data.length; i++){
	// 				html += '<option value='+data[i].nama_kelas+'>'+data[i].jurusan+'</option>';
	// 			}				
	// 			$('#kelas').html(html);
	// 			//$('#kelas').change();
	// 		}
