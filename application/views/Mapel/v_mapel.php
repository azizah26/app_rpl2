...
<p class="mb-4">Data Pokok Pendidikan atau Dapodik adalah sistem pendataan (database) berskala nasional yang
	...
	<div class="row" style="margin-top: 30px;">
		<div class="col-md-4 col-md-offset-3">
			...
			<?php } ?>
			<form action="<?= base_url('index.php/ImportControllerMapel/import_excel'); ?>" method="post" enctype="multipart/form-data">
...
<div class="card shadow mb-4">
    ...
    <center><h6 class="m-0 font-weight-bold text-primary" >Data Mapel</h6></center>
            </div>
    <div class="card-body">
    <a href="<?php echo base_url('index.php/mapel/tambah');?>" class='btn btn-sm 
    btn-primary pull-right'><i class="fa-solid fa-notes-medical"></i>Mapel Baru</a>
 ...
 <a href="<?php echo base_url().'index.php/mapel/edit/'.$a->id_mapel; ?>" class="btn btn-sm btn-warning"><i class="fa fa-wrench"></i> Edit</a>
 <a href="<?php echo base_url().'index.php/mapel/hapus/'.$a->id_mapel; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus</a>
 </td>
 </tr>
 <?php 
 }
