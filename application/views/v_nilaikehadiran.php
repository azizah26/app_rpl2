...
<div class="container">
 ...
 <h4>Tambah Data Nilai Kehadiran </h4>
 </div>
 <div class="card-body">
 <a href="<?php echo base_url().'index.php/nilai_kehadiran/' ?>" class='btn btn-sm btn-light btn-outline-dark pull-right'><i class="fa fa-arrow-left"></i> Kembali</a>
 <br/>
 <br/>
 <form method="post" action="<?php echo base_url().'index.php/nilai_kehadiran/tambah_aksi'; ?>">
...
$(document).ready(function(){
  ...
  $('#kelas').change(function(){
    ...
    var kelas = $('#kelas').val();
        ...
        html += '<table table class="table table-bordered  table-hover table-default" id="dataTable" width="100%" cellspacing="0"> <tr><td>No</td><td>Nis</td><td>Nama Siswa</td><td>Sakit</td><td>Izin</td><td>Tanpa Keterangan</td></tr>';

				for(i=0; i<data.length; i++){
					html += '<tr><td>'+no+'</td><td>'+data[i].nis+'</td><td>'+data[i].nama+'</td><td><input type="text" class="form-control" name="sakit'+i+'"></td><td><input type="text" class="form-control" name="izin'+i+'"></td><td><input type="text" class="form-control" name="tanket'+i+'"></td></tr>';
