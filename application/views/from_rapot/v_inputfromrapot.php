...
<body>
  ...
  <form class="modal-content animate" action="<?php echo base_url(). 'index.php/from_rapot/tambah_aksi'; ?>" method="post">
    ...
    <a href=http://localhost/app_rpl_2/index.php/from_rapot><span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close">&times;</span></a>
