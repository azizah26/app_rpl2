...
<div class="card shadow mb-4">
    ...
    <a href="<?php echo base_url('index.php/ControllerPdfPembinaEkskul/index');?>" target="_blank" class='btn btn-sm 
...
<a href="<?php echo base_url().'index.php/SetPembinaEkskul/hapus/'.$p->id; ?>" 
